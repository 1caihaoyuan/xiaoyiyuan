...
const _sfc_main = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const setStyle = () => {
      ...
      iconStyle.value = ["iconWidth" + props.iconWidth + "rpx", "iconHeight" + props.iconHeight + "rpx"].join(";");
    };
    const backOrHome = () => {
      if (pages.value > 1) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        c: common_vendor.s("height:" + menu.height * 2 + "rpx;line-height:" + menu.height * 2 + "rpx;margin-top:" + (menu.top * 2 - status.value) + "rpx;margin-left:30rpx; margin-right:" + (menu.width * 2 + 24) + "rpx;background: #f4f4f4;border-radius: 200rpx;text-align:center;"),
        d: common_vendor.s("line-height:" + (navHeight.value - 12) + "rpx;padding-left:20rpx;")
      } : common_vendor.e({
        e: pages.value > 1
      }, pages.value > 1 ? {
