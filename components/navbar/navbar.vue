<template>
  <view class="nav">
    ...
    <view v-if="isHome" class="headNav" :style="'line-height:' + (navHeight - 12) + 'rpx;padding-left:20rpx;'">
      ...
      <view style="flex:1">
        <navigator
          ...
          :style="
            ...
            'rpx;margin-top:' +
            (menu.top * 2 - status) +
            'rpx;margin-left:30rpx; margin-right:' +
            (menu.width * 2 + 24) +
    ...
    <view v-else class="navbar" :style="'height:' + navHeight + 'rpx;' + containerStyle">
      <view class="back-icon" @click="backOrHome">
        <image v-if="pages > 1" src="../../static/resource/navbar/logo.png"></image>
