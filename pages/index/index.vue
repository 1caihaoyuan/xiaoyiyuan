<template>
  <view>
    ...
    <view style="margin-top: 170rpx;">
      <view class="weui-cell" style="background-color: #fff9ed;height: 20rpx;">
        <view class="weui-cell_hd">
          <image src="/static/resource/images/ic_myapp.png" style="display: block;width: 40rpx;margin-right: 14rpx;height: 40rpx;"></image>
        </view>
        <view class="weui-cell_bd">
          <text style="color: #be9719;font-size: 26rpx;">点击右上角“添加到我的小程序”，方便下次找到</text>
        </view>
        <view class="weui-cell_ft">
          <image src="/static/resource/images/modal_closer.png" style="display: block;width: 30rpx;margin-right: 30rpx;height: 32rpx;padding-left: 20rpx;"></image>
        </view>
      </view>
      </view>
      ...
      <view v-if="navs && navs.length > 0" class="nav-list">
        <block v-for="(item,index) in navs" :key="index">
          <view class="nav-item" @click="onNavTap" :data-index="index">
            <view class="nav-pic"><image :src="item.pic_image_url" mode="widthFix"></image></view>
      ...
      <view class="weui-cells hosp-list">
        ...
        <view class="weui-cell hosp-item weui-cell_access" v-for="(item,index) in hospitals" :key="item.id" :data-hid="item.id" @click="toHospital">
          <!-- 医院列表图片 -->
          <view class="weui-cell_hd">
            <image :src="item.avatar ? item.avatar_url : '../../static/resource/images/avatar.jpg'" class="hosp-avatar" mode="aspectFill"></image>
          </view>
          <!-- 医院列表内容 -->
          <view class="weui-cell_bd">
            <view>
